...
async function main() {
    ...
    const user2 = await prisma.user.create({
        data: {
            ...
            password: await bcrypt.hash("password123", 10),
            name: "Susanti Mekar Sari",
            role: "USER",
            age: 29,
            educationalBackground: "S1",
            verified: true,
            profile: {
                create: {
                    ...
                    address: "5678 Main St, City, Country",
                },
            },
        },
    });
                ...
                create: [
                    {
                        ...
                        choices: {
                            create: [{ text: "3" }, { text: "4" }, { text: "5" }, { text: "6" }],
                        },
                    ...
                    },
                    {
                        ...
                        choices: {
                            create: [{ text: "Array" }, { text: "String" }, { text: "Object" }, { text: "Function" }],
                        },
                    ...
                    },
                    {
                        ...
                        choices: {
                            create: [{ text: "null" }, { text: "undefined" }, { text: "object" }, { text: "function" }],
                        },
                    ...
                    },
                    {
                        ...
                        choices: {
                            create: [{ text: "var" }, { text: "let" }, { text: "const" }, { text: "All of the above" }],
                        },
                    ...
                    },
                    {
                        ...
                        choices: {
                            create: [{ text: "for" }, { text: "while" }, { text: "foreach" }, { text: "do-while" }],
                        },
                    ...
                    },
                    {
                        ...
                        choices: {
                            create: [{ text: "push()" }, { text: "pop()" }, { text: "shift()" }, { text: "unshift()" }],
                        },
                    ...
                    },
                    {
                        ...
                        choices: {
                            create: [{ text: "null" }, { text: "undefined" }, { text: "0" }, { text: "false" }],
                        },
                    ...
                    },
                    {
                        ...
                        choices: {
                            create: [{ text: "exit" }, { text: "break" }, { text: "continue" }, { text: "return" }],
                        },
                    ...
                    },
                    {
                        ...
                        choices: {
                            create: [{ text: "pop()" }, { text: "push()" }, { text: "shift()" }, { text: "slice()" }],
                        },
                    ...
                    },
                    {
                        ...
                        choices: {
                            create: [{ text: "let" }, { text: "var" }, { text: "const" }, { text: "static" }],
                        },
                    ...
                    },
                    {
                        ...
                        choices: {
                            create: [{ text: "true" }, { text: "false" }, { text: "undefined" }, { text: "null" }],
                        },
                    ...
                    },
                    {
                        ...
                        choices: {
                            create: [{ text: "null" }, { text: "0" }, { text: '"false"' }, { text: "undefined" }],
                        },
                    ...
                    },
                    {
                        ...
                        choices: {
                            create: [{ text: "10" }, { text: "55" }, { text: "5" }, { text: "Error" }],
                        },
            ...
            questions: {
                create: [
                    ...
                    },
                    {
                        ...
                        choices: {
                            create: [{ text: "function" }, { text: "def" }, { text: "define" }, { text: "func" }],
                        },
                    ...
                    },
                    {
                        ...
                        choices: {
                            create: [{ text: "3" }, { text: "6" }, { text: "0" }, { text: "1" }],
                        },
                    ...
                    },
                    {
                        ...
                        choices: {
                            create: [{ text: "append()" }, { text: "add()" }, { text: "push()" }, { text: "insert()" }],
                        },
                    ...
                    },
                    {
                        ...
                        choices: {
                            create: [{ text: "5" }, { text: "6" }, { text: "8" }, { text: "16" }],
                        },
                    ...
                    },
                    {
                        ...
                        choices: {
                            create: [{ text: "int" }, { text: "float" }, { text: "char" }, { text: "str" }],
                        },
                    ...
                    },
                    {
                        ...
                        choices: {
                            create: [{ text: "True" }, { text: "False" }, { text: "None" }, { text: "Error" }],
                        },
                        correctAnswerId: 1, // Correct answer is 'True'
                    },
                    {
                        ...
                        choices: {
                            create: [{ text: "class" }, { text: "define" }, { text: "def" }, { text: "cls" }],
                        },
                    ...
                    },
                    {
                        ...
                        choices: {
                            create: [{ text: "2.5" }, { text: "2" }, { text: "3" }, { text: "2.0" }],
                        },
                    ...
                    },
                    {
                        ...
                        choices: {
                            create: [{ text: "8" }, { text: "15" }, { text: "53" }, { text: "35" }],
                        },
                    ...
                    },
                    {
                        questionText: "What is the output of `5 % 2`?",
                        choices: {
                            create: [{ text: "2" }, { text: "3" }, { text: "1" }, { text: "0" }],
                        },
                    ...
                    },
                    {
                        ...
                        choices: {
                            create: [{ text: "size()" }, { text: "length()" }, { text: "len()" }, { text: "count()" }],
                        },
    ...
    await prisma.jobApplication.create({
        data: {
            ...
            userId: user2.id,
            status: "PENDING",
            cvUrl: "https://example.com/cv/user2.pdf",
