...
const variantStyles = {
    solid: {
        slate: "bg-primary text-white hover:bg-primary-dark hover:text-slate-100 active:bg-primary-dark active:text-slate-300 focus-visible:outline-primary",
        blue: "bg-blue-600 text-white hover:text-slate-100 hover:bg-blue-500 active:bg-blue-800 active:text-blue-100 focus-visible:outline-blue-600",
        white: "bg-white text-primary hover:bg-blue-50 active:bg-blue-200 active:text-slate-600 focus-visible:outline-white",
    },
    outline: {
